...
namespace System.Numerics
{
          ...
          , IComparable<BigDecimal>
    {
        ...
        public BigDecimal(BigInteger mantissa, int exponent, int precision):this()
        {
            Mantissa = mantissa;
            Exponent = exponent;
            Precision = precision;
        ...
        {
            var exponentChange = dividend.Precision - (NumberOfDigits(dividend.Mantissa) - NumberOfDigits(divisor.Mantissa));
            if (exponentChange < 0)
            {
                exponentChange = 0;
            }
